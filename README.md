...
`plan: starter` ใน `render.yaml` คือแพ็กเกจที่**ไม่หลับ** ($7/เดือน)
ถ้าเปลี่ยนเป็น `plan: free` เครื่องจะหลับเมื่อไม่มีคนใช้ 15 นาที และคนทักคนแรกต้องรอราวครึ่งนาที
ซึ่งนานเกินกว่าที่ LINE จะรอ ทำให้ข้อความแรกหายไปได้
