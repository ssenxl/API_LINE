...
export const CHAPTER_PROMPT_VERSION = 2;
...
- gaps: ไม่เกิน 3 ข้อ เฉพาะช่องโหว่ที่คนทำงานจะเจอจริงจากกฎที่มี เช่น เงื่อนไขที่ตกหล่น (ออเดอร์ 500 กิโลพอดีใช้เครื่องไหน) ห้ามใส่เรื่องทั่วไปที่ไม่เกี่ยวกับกฎ ถ้าไม่มีให้เป็น []
- ห้ามเพิ่มข้อมูลที่ไม่มีอยู่ในกฎ
